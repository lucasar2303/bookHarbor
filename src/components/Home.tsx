...
function Home(){
    ...
    return(
        <div className='flex justify-center w-full h-screen max-w-7xl m-auto flex-col md:flex-row mt-10 px-4 text-center md:text-left'>
                ...
                <div className='mt-10 md:mt-0 md:pr-2 lg:mt-20 lg:pr-10'>
                    ...
                    <button className="relative flex w-full md:w-11/12 lg:w-10/12 py-2 px-4 mb-5 rounded text-xl items-center justify-between overflow-hidden bg-blue-principal
                     text-white shadow-2xl transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:-translate-x-10 before:bg-blue-secondary
                      before:opacity-80 before:duration-500 before:ease-out hover:before:h-56 hover:before:w-56">
                        <span className="text-left font-semibold text-xl relative z-10">Encontre seu livro </span>
