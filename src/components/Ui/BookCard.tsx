...
function BookCard(){
    ...
    return(
        ...
        <div className="perspective-container h-96 w-56 cursor-pointer" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                ...
                <div className="back absolute w-full h-full shadow-2xl border p-5 flex flex-col justify-between border-gray-100 rounded-xl backface-hidden rotate-y-180">
                    ...
                    <div className="">
                        <div className="flex justify-between mb-2 gap-2">
                            <button className=' shadow-xl rounded-sm bg-white p-2 flex-auto border border-gray-100 hover:text-blue-principal hover:-translate-y-1 duration-300'><FontAwesomeIcon icon={faList} size="lg" /></button>
                            <button className=' shadow-xl rounded-sm bg-white p-2 flex-auto border border-gray-100 hover:text-blue-principal hover:-translate-y-1 duration-300'><FontAwesomeIcon icon={faCheck} size="lg" /></button>
                            <button className=' shadow-xl rounded-sm bg-white p-2 flex-auto border border-gray-100 hover:text-blue-principal hover:-translate-y-1 duration-300'><FontAwesomeIcon icon={faStar} size="sm" /></button>
                            <button className=' shadow-xl rounded-sm bg-white p-2 flex-auto border border-gray-100 hover:text-blue-principal hover:-translate-y-1 duration-300'><FontAwesomeIcon icon={faPlus} size="lg" /></button>
                        </div>
                        <div className="flex justify-between gap-2">
                            ...
                            <button className=' shadow-xl rounded-sm bg-red bg-red-principal p-2 px-4 hover:opacity-80 duration-300'><FontAwesomeIcon icon={faTrash} size="xl" className='text-white'/></button>
                        </div>
                    </div>
                </div>
            </div>
