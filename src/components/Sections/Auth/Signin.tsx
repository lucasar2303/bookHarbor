    ...
    <div className="w-full h-full flex items-center mt-2 md:mt-0 fade-in">
        <div className=' w-10/12 md:w-8/12 m-auto bg-white'>
            ...
            <form action="">
                ...
                <button type='submit' id='btnSubmit' className='w-full mt-16 bg-black-principal hover:bg-blue-third  transition-all duration-300 text-white text-xl rounded p-2'>Entrar</button>
